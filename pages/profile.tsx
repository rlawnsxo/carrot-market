        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex flex-col">
            ...
            <Link href={"/profile/edit"}>
              <a className="text-sm text-gray-600">Edit profile &rarr;</a>
            </Link>
          </div>
        </div>
        <div className="mt-10 flex justify-around">
          <div className="flex flex-col items-center">
            <Link href={"/profile/sold"}>
              <a className="w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
            ...
            <span className="text-sm font mt-2 font-medium text-gray-700">
              판매내역
            </span>
          </div>
          <div className="flex flex-col items-center">
